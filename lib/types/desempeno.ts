...
export const OBJETIVOS_POR_PUESTO: Record<string, Objetivo[]> = {
    ...
    "TÉCNICO DE MANTENIMIENTO DE EDIFICIOS A": _OBJETIVOS_TECNICO_EDIFICIOS,
    "TÉCNICO DE MANTENIMIENTO DE EDIFICIOS B": _OBJETIVOS_TECNICO_EDIFICIOS,
    ...
    /* SISTEMAS */
    "COORDINADOR RPS": _OBJETIVOS_COORDINADOR_RPS,
    ...
    /* LOGISTICA */
    "JEFE DE LOGÍSTICA": _OBJETIVOS_LOGISTICA,
    "SUPERVISOR DE LOGÍSTICA": _OBJETIVOS_SUPERVISOR_LOGISTICA,
    /* PROYECTOS */
    "AUXILIAR DE PROYECTOS": _OBJETIVOS_AUXILIAR_PROYECTOS,
    "INGENIERO DE PROYECTOS": _OBJETIVOS_INGENIERO_PROYECTOS,
    "LIDER DE PROYECTOS": _OBJETIVOS_LIDER_PROYECTOS,
