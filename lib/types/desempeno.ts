...
const _OBJETIVOS_AUXILIAR_BASCULA: Objetivo[] = [
  {
    numero: 1,
    descripcion: "Realizar los pesajes al 100% de la producción por turno",
    resultado: "80%",
    porcentaje: "NA",
    comentarios: "",
  },
  {
    numero: 2,
    descripcion: "Asegurar el 100% de entrega de piezas al área de Almacén",
    resultado: "80%",
    porcentaje: "NA",
    comentarios: "",
  },
  {
    numero: 3,
    descripcion: "Asegurar la cantidad de producción al 100%",
    resultado: "80%",
    porcentaje: "NA",
    comentarios: "",
  },
  {
    numero: 4,
    descripcion:
      "Realizar el 100% de traspasos con el kardex correspondiente en el RPS",
    resultado: "100%",
    porcentaje: "NA",
    comentarios: "",
  },
  {
    numero: 5,
    descripcion: "Portar el 100% de su EPP y uniforme diariamente",
    resultado: "90%",
    porcentaje: "NA",
    comentarios: "",
  },
...
const _OBJETIVOS_ANALISTA_SEGURIDAD: Objetivo[] = [];
...
export const OBJETIVOS_POR_PUESTO: Record<string, Objetivo[]> = {
  ...
  /*LISTADO PUESTO RECURSOS HUMANOS */
  ...
  "ANALISTA DE SEGURIDAD E HIGIENE": _OBJETIVOS_ANALISTA_SEGURIDAD,
