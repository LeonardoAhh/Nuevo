...
export const GUIDE_STEPS: readonly GuideStep[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Avanza por Datos, Objetivos, Responsabilidades, Competencias y Revisión.",
      "Captura directamente un porcentaje o selecciona No aplica en cada criterio.",
      "En competencias, selecciona una respuesta de 0 a 4; el cero es una calificación válida.",
    ],
    weights: [
    ...
    note: "Puedes volver a un paso anterior sin perder la captura. Los pasos pendientes muestran qué falta antes de continuar.",
  },
  {
    id: "save",
    label: "Guardar",
    title: "Guarda la evaluación",
    description: "Revisa la captura y guarda desde el último paso de la evaluación.",
    instructions: [
      "Confirma el empleado, el periodo y el evaluador seleccionado.",
      "Atiende los avisos que impidan guardar la evaluación.",
      "Presiona Guardar evaluación y espera el estado de confirmación antes de imprimir.",
    ],
  ...
  },
  {
    ...
    note: "Al guardar verás acciones persistentes para imprimir o comenzar otra evaluación.",
  },
];
