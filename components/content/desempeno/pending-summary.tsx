...
export function PendingSummary({
  ...
  return <>{!data && totalEvals > 0 && <div className="w-full">
      {(() => {
        ...
        let iconBgClass = "border border-success/20 bg-success/10 text-success";
        ...
        if (hasVencidas) {
          ...
          iconBgClass = "border border-destructive/20 bg-destructive/10 text-destructive";
          ...
          iconBgClass = "border border-warning/30 bg-warning/10 text-warning";
        ...
        return <div className={cn("flex flex-col items-center justify-between gap-6 rounded-xl border p-5 sm:flex-row", bgClass)}>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 w-full">
            ...
            <div className="space-y-4 w-full flex-1">
              ...
              <div className="grid grid-cols-3 gap-3 w-full sm:w-auto">
                {/* Vencidas */}
                <div className="relative flex flex-col overflow-hidden rounded-md border bg-card p-3">
