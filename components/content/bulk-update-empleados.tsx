  ...
  return (
    <Dialog open={open} onOpenChange={v => { if (!v) handleClose() }}>
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto bg-card">
        <DialogHeader>
          <DialogTitle>Actualización Masiva de Empleados</DialogTitle>
          <DialogDescription>
            Carga un JSON con los campos: numero, turno, departamento, area.
            Se actualizará tanto en Ingresos como en Capacitación (Historial).
          </DialogDescription>
        </DialogHeader>
        ...
        {step === "upload" && (
          <div className="space-y-4">
            <div className="border-2 border-dashed border-border rounded-xl p-8 text-center">
              ...
              <pre className="text-xs bg-muted rounded-lg p-3 text-left inline-block mx-auto mb-4 max-w-sm">
{`[
  {
    "numero": "123",
    "turno": "2",
    "departamento": "PRODUCCIÓN",
    "area": "PRODUCCIÓN 2DO TURNO"
  }
]`}
              </pre>
              <div>
