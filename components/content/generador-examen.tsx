      ...
      <>
        ...
        <div className="no-print px-4 sm:px-6 pb-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <div className="flex gap-2 sm:ml-auto">
            <Button variant="outline" className="gap-2" onClick={handleNuevoExamen} aria-label="Nuevo examen" title="Nuevo examen">
              <RefreshCw size={14} />
            ...
            <Button className="gap-2" onClick={handleImprimir} aria-label="Imprimir" title="Imprimir">
              <Printer size={14} />
              <span>Imprimir</span>
            </Button>
          </div>
