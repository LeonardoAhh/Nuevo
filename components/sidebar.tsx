...
export default function Sidebar({
  ...
  // For evaluador: only routes in EVALUADOR_ALLOWED_ROUTES are shown.
  // For other roles: all items are visible.
  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      >
        ...
        {/* opacity-0 mientras el rol carga para evitar el flash de items incorrectos */}
